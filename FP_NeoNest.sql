...
VALUES
    ('TR002', '2023-12-02', 'Cash', 12000000.00, 'CST002', 'EMP002'),
    ('TR005', '2023-12-05', 'Cash', 2500000.00, 'CST005', 'EMP005'),
    ('TR008', '2023-12-08', 'Cash', 3500000.00, 'CST008', 'EMP008'),
    ('TR001', '2023-12-01', 'Credit Card', 5000000.00, 'CST001', 'EMP001'),
    ('TR004', '2023-12-04', 'Credit Card', 4500000.00, 'CST004', 'EMP004'),
    ('TR007', '2023-12-07', 'Credit Card', 1000000.00, 'CST007', 'EMP007'),
    ('TR010', '2023-12-10', 'Credit Card', 800000.00, 'CST010', 'EMP010'),
    ('TR003', '2023-12-03', 'Debit Card', 3500000.00, 'CST003', 'EMP003'),
    ('TR006', '2023-12-06', 'Debit Card', 3000000.00, 'CST006', 'EMP006'),
    ('TR009', '2023-12-09', 'Debit Card', 600000.00, 'CST009', 'EMP009');
